...
int report_count = rMgr.getReportCount(id);
  ...
  %>
	  ...
	  for (int i = 0; i < numPerPage; i++) { 
		...
		<% }
				  ...
				  if(!report.equals("0") && report_count==0)
				  {%>
					  <tr>
						<td colspan="4" align="center">등록된 게시물이 없습니다 .</td>
					</tr>
...
<br><br>
						...
						<input type="button" class="button" value="받은 답장함" onclick="location='1.receiveReply.jsp'" >
							<%if(newReceive!=0){ %>
