...
<script type="text/javascript">
	function report(report,check){
	 ...
	 if(report>=10){
			alert("현재 회원님은 10회 이상 신고가 들어왔습니다.\n10회 이상시 자동으로 탈퇴처리 됩니다.");
				...
				<div class="inner">
					<div class="flex flex-2">
						<article>
							...
							<br/>
							<footer>
								<input type="button" onclick="location.href='1.send_contents.jsp'" class="button" value="고민 비우기"/> 
							</footer>
						</article>
						<article>
							<div class="image round">
							...
							<footer>
								<input type="button" onclick="location.href='2.question.jsp'" class="button" value="To.오늘의 나"/>
							</footer>
						</article>
